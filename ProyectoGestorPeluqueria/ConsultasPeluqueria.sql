...
--EXEC dbo.SP_ELIMINAR_PELUQUERIA @PeluqueriaID = 7;
--EXEC dbo.SP_ELIMINAR_SERVICIO  @ServicioID = 1;
--EXEC dbo.SP_ELIMINAR_HORARIO   @HorarioID  = 1;
--EXEC dbo.SP_ELIMINAR_EMPLEADO  @EmpleadoID = 1;
-------------------------------------
GO
